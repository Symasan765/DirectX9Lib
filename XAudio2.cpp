...
{
	{"BGM/STARWARS-theme-.wav", true},	// サンプルBGM（ループさせるのでtrue設定）
	{"BGM/ダースベイダーのテーマ.wav", true},	// サンプルBGM
	{"BGM/スターウォーズ王座の間_01.wav", true},		// サンプルSE（ループしないのでfalse設定）
	{"SE/自機ショット.wav", false},		// サンプルSE
	{"SE/爆発音.wav", false},		// サンプルSE
	{"SE/se_maoudamashii_element_fire09.wav", false},			// サンプルSE
	{"SE/EnemyShot.wav", false},		// サンプルSE
	{"SE/フォースを使え.wav", false},		// サンプルSE
	{"BGM/エンディング.wav", false},		// サンプルSE
